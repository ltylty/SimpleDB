...
import server.parser.util.ParseUtil;
...
public final class ServerParseSet {
    ...
    public static final int TABLE_PATH = 11;
    ...
    public static int parse(String stmt, int offset) {
        ...
        for (; i < stmt.length(); i++) {
            switch (stmt.charAt(i)) {
                ...
                case 'T':
                case 't':
                    return checkTablePathAndTrans(stmt, i);
                default:
                    return OTHER;
            }
        }
    ...
    private static int checkTablePathAndTrans(String stmt, int offset) {
        if (stmt.length() > offset + 9) {
            ...
            if ((c1 == 'a' || c1 == 'A') && (c2 == 'b' || c2 == 'B') && (c3 == 'l' || c3 == 'L') && (c4 == 'e' || c4
                    == 'E') && (c5 == '_') && (c6 == 'p' || c6 == 'P') && (c7 == 'a' || c7 == 'A') && (c8 == 't' || c8
                    == 'T') && (
                    c9 == 'h' || c9 == 'H')
                    ) {
                return TABLE_PATH;
